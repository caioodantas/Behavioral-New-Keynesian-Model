...
module DSGE
    ...
    export
        ...
        Model990, Model1002, Model1010, Model805, Model904, SmetsWouters, SmetsWoutersOrig, AnSchorfheide, XGabaix,
    ...
    include("models/representative/gabaix/gabaix.jl")
    include("models/representative/gabaix/subspecs.jl")
    include("models/representative/gabaix/eqcond.jl")
    include("models/representative/gabaix/observables.jl")
    include("models/representative/gabaix/measurement.jl")
    include("models/representative/gabaix/pseudo_observables.jl")
    include("models/representative/gabaix/pseudo_measurement.jl")
    include("models/representative/gabaix/augment_states.jl")
